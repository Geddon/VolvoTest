...
{
    public partial class CongestionTaxContext : DbContext, IDataContext
    {
        ...
        public virtual DbSet<VehicleTypeZone> VehicleTypeZones { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Passage>(entity =>
            {
                ...
                entity.HasOne(d => d.Tariff)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Passage_Tariff");
            ...
            modelBuilder.Entity<TaxFreeDay>(entity =>
            {
                ...
                entity.HasOne(d => d.Zone)
                    .WithMany(p => p.TaxFreeDays)
                    .HasForeignKey(d => d.ZoneId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_TaxFreeDay_Zone");
            });
            ...
            modelBuilder.Entity<TaxFreePeriod>(entity =>
            {
                ...
                entity.HasOne(d => d.Zone)
                    .WithMany(p => p.TaxFreePeriods)
                    .HasForeignKey(d => d.ZoneId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_TaxFreePeriod_Zone");
            });
            ...
            modelBuilder.Entity<VehicleTypeZone>(entity =>
            {
                entity.HasKey(bc => new { bc.VehicleTypeId, bc.ZoneId });

                entity.ToTable("VehicleTypeZone");

                entity.HasOne(d => d.VehicleType)
                    .WithMany()
                    .HasForeignKey(d => d.VehicleTypeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_VehicleTypeZone_VehicleType");

                entity.HasOne(d => d.Zone)
                    .WithMany()
                    .HasForeignKey(d => d.ZoneId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_VehicleTypeZone_Zone");
            });
